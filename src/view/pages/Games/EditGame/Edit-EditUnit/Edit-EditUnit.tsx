...
function EditEditUnit() {
    ...
    useEffect(() => {
        const unit: Unit = location.state?.unit || safeParse(localStorage.getItem("edit-editUnit"));
    ...
    const handleSaveUnit = () => {
        ...
        updatedGame.units = updatedGame.units?.map(u => u.unitID === updated.unitID ? updated : u) || [];
    ...
    return (
        <div className="main-container-edit-unit">
            ...
            <div className="edit-unit-container" dir="rtl">
                ...
                {selectedLocation && (
                    <div className="input-group">
                        <label className="input-label">{EditUnitHebrew.SelectedLocation}</label>
                        <div className="selected-task">{selectedLocation.name}</div>
                    </div>
                )}
                {selectedObject && (
                    <div className="input-group">
                        <label className="input-label">{EditUnitHebrew.SelectedObject}</label>
                ...
                <div className="options-container">
                    <div className="option-section">
                        <div className="button-group">
                            <button type="button" className="cancel-button" onClick={() => navigate("/EditGameUnitsPage")}>
