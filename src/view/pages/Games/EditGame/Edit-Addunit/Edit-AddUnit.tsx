...
function EditAddUnit() {
    const [name, setName] = useState(localStorage.getItem("edit-addUnitName") || "");
    const [description, setDescription] = useState(
        localStorage.getItem("edit-addUnitDescription") || ""
    );
    const [hint, setHint] = useState(localStorage.getItem("edit-addUnitHint") || "");
    ...
    useEffect(() => {
        ...
        localStorage.setItem("edit-selectedLocation", JSON.stringify(selectedLocation));
                    ...
                    <div className="option-section">
                        <div className="add-buttons">
                            <button
                                ...
                                onClick={() => navigate("/edit-ChooseLocation-add", { state: { returnTo: "/EditAddUnit" } })}
                            >
                            ...
                            <button
                                type="button"
                                className="option-button"
                                onClick={() => navigate("/edit-ChooseTask-add", { state: { returnTo: "/EditAddUnit" } })}
                            >
